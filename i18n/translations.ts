...
const he = {
  ...
  summary: {
    ...
    loading_ai: "מנתח את תשובותיך... התהליך עשוי לארוך כדקה.",
  ...
  categoryModal: {
    ...
    loading: "מייצר תובנה... ייתכן עיכוב קל עקב עומס.",
...
const en = {
  ...
  summary: {
    ...
    loading_ai: "Analyzing your answers... This process may take about a minute.",
  ...
  categoryModal: {
    ...
    loading: "Generating insight... There may be a slight delay due to high demand.",
